...
async function main() {
    ...
    const routerContract = "0x4C2AA252BEe766D3399850569713b55178934849";
    ...
    const challengefactory = await challengeFactory.deploy(ownerAddress, settlers, routerContract);
